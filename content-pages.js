const pages = {
  "about.html": {
    eyebrow: "About Us",
    title: "Technumen is IT and Business Consulting Services Firm",
    intro: "We are insights-driven and outcome-based to help accelerate returns on your IT and business investments.",
    sections: [
      {
        label: "About Us",
        title: "Technology consulting built on integrity and innovation",
        body: "Technology has been a pillar for any business. We provide trustworthy, time-tested technology consulting services to companies that want to progress, remain relevant, and excel through leading-edge digital transformation techniques. Since 2016, Technumen has helped organizations turn technology-focused innovation into measurable outcomes."
      },
      {
        label: "Mission and Vision",
        title: "To be the core of business transformation with eternal principles",
        body: "Our mission is to be the world leader in Digital Transformation and help businesses leverage technological advancements while providing maximum value.",
        stats: [["2016", "Established"], ["1500+", "People"], ["50+", "Customers"], ["2", "Offices"]]
      },
      {
  ...
  "services.html": {
    ...
    title: "Services Built for the Digital Epoch",
    intro: "Five core service areas anchored by commitment for excellence and years of delivery success.",
    sections: [
      {
  ...
  "service-digital-engineering.html": {
    ...
    title: "Software Products & Digital Engineering",
    intro: "Software products and digital engineering are ecosystems of resources that help businesses modernize, automate, build, and launch new products.",
    sections: [
      {
        label: "Overview",
        title: "Secure application lifecycles for modern businesses",
        body: "Applications are the mainstay for any business. We develop apps for B2B and B2C clients and support seamless connectivity across customer relationship management, internal data sharing, prospect response, and daily operational workflows."
      },
      {
        label: "Key Offerings",
        ...
        cards: [
          ...
          ["DevOps", "Implement CI/CD pipelines, automated testing, infrastructure-as-code, and modern DevOps practices."],
      ...
      },
      {
        ...
        title: "Solutions",
        cards: [
          ["Custom Applications", "Custom-built applications for the entire product lifecycle."],
          ["Cost Optimization", "Reduce time and cost through modern architecture and newer technology adoption."],
          ["Modern Features", "Accelerate new feature launch while improving security, scalability, and customer experience."]
        ]
      }
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          ["Cloud Infrastructure & DevOps", "Build scalable infrastructure with IaC, CI/CD pipelines, and automated provisioning."],
          ["Managed Cloud Services", "Optimize performance, cost, security, and compliance with continuous support."]
        ]
      },
      {
        label: "What We Deliver",
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          ["Test Environment Management", "Identify issues around cloud adoption and define architecture required to meet business goals."]
        ]
      },
      {
        label: "What We Deliver",
  ...
  "service-security.html": {
    ...
    intro: "Our cybersecurity solutions provide end-to-end protection for digital assets, from cloud infrastructure to application security.",
    sections: [
      {
        label: "Security Portfolio",
        title: "Security Services Portfolio",
        body: "With cyber threats evolving in scale and sophistication, organizations need a trusted security partner. Technumen delivers enterprise-grade services tailored to risk profile, compliance requirements, and business objectives."
      },
      {
        label: "Key Offerings",
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          ["Core Systems Expertise", "Implementation, configuration, and quality engineering for PolicyCenter, BillingCenter, and ClaimCenter."]
        ]
      },
      {
        label: "P&C Insurance",
  ...
  "careers.html": {
    ...
    intro: "Our business growth is directly determined by our consultant base. We actively seek hardworking, intelligent, talented, and determined individuals to join our global network.",
    sections: [
      {
      ...
      },
      {
        ...
        title: "Global Staffing & Delivery Excellence",
        cards: [
    ...
    cta: ["Ready to Shape the Future?", "Send your resume directly to join our global network of exceptional consultants.", "Send Resume"]
  },
  "resources.html": {
    eyebrow: "Resources",
    ...
    sections: [
      {
        ...
        cards: [
          ["Audit Heritage", "CMMi SVC Level 3 appraisal, ISO/IEC 27001 certification, and regular SOC 2 Type II audits."],
          ["Infrastructure Defense", "Microsoft Azure security services, O365 infrastructure, EDTR platforms, and annual penetration tests."],
          ["Identity & Access Control", "Conditional Access Policies, MFA, and zero-trust principles."],
          ["Operational Security", "Security awareness training, incident response protocols, phishing campaigns, and background checks."]
        ]
      },
      {
        label: "Insights",
